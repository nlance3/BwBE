...
public class AssetLoader {
	...
	public static Texture logoTexture, backgroundTexture;
	public static TextureRegion logo, background;
	...
	public static void load() {
		...
		backgroundTexture = new Texture(Gdx.files.internal("data/gameBoard.png"));
